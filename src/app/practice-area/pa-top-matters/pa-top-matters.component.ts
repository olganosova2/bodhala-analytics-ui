...
import {IPracticeArea} from '../practice-area.model';
...
@Component({
  selector: 'bd-pa-top-matters',
  templateUrl: './pa-top-matters.component.html',
  styleUrls: ['./pa-top-matters.component.scss']
})
export class PaTopMattersComponent implements OnInit {
  errorMessage: any;
