...
export class SavingsFirmGridComponent implements OnInit, AfterViewInit {
  ...
  initColumns(): void {
    this.gridOptions.columnDefs = [
      ...
      {headerName: 'Internal Meetings', field: 'overstaffing',  cellRenderer: this.agGridService.roundCurrencyCellRenderer, ...this.defaultColumn, width: 250, comparator: this.agGridService.zeroNumberComparator },
