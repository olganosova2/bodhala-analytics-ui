...
export class QbrNextStepsComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    for (const rec of this.savedInsights) {
      ...
      // this.nextStepsForm.addControl(rec.sort_order + 'potential_savings_override', new FormControl(rec.potential_savings_override, [Validators.minLength(0), Validators.maxLength(25)]));
